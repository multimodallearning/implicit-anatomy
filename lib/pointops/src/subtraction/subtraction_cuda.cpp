...
{
    const float *input1 = input1_tensor.data<float>();
    const float *input2 = input2_tensor.data<float>();
...
void subtraction_backward_cuda(int n, int nsample, int c, at::Tensor idx_tensor, at::Tensor grad_output_tensor, at::Tensor grad_input1_tensor, at::Tensor grad_input2_tensor)
{
    ...
    float *grad_input1 = grad_input1_tensor.data<float>();
    float *grad_input2 = grad_input2_tensor.data<float>();
